    ...
    def Start2(self,user,day,MaxStretch):
        ...
        class MainWindow(Tk):
            def __init__(self):
                ...
                self.Rep.grid(row=1,columnspan=3, sticky = "E") #user[0][0]<---Used to get user info
                ...
                self.Stop = Button(self, text="Stop", bg='firebrick1', fg='white', font=myFont, height = 10, width=20, command=self.close).grid(row=2,column=2, sticky = "W")
                ...
                if btn2[2] == False:
                    ...
                    if time.time()-btn1[7]>1.5 and btn2[5] == False: #Used to display messages
                        if btn2[4] == 3:
                            ...
                            btn2[3] = "Return To Home And Rest For 2 Minutes"
                            btn2[5] = True
                            btn1[7] = time.time()
        ...
        if __name__ == '__main__':
            with Manager() as manager:
                ...
                btn2 = manager.list([0, False, False, "", 1, False, 0, False, 0])
                info = manager.list([])
